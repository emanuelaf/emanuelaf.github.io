...
### Building _age pyramid_ from microdata
...
I create my age pyramid in two steps: first I calculate the frequency distribution of the age class for men and women separately and save it in a table, and then I represent the table with a plot. In the next few lines I will describe the code that produces a nice and kneet _age pyramid_.
