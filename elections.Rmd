...
In one of my lessons I was to give students an overview on how to compile reports with rmarkdown. As Italians, when it gets to elections time, elections is the only thing we hear about in the news for months. So I was inspired by the news, and decided to get them to work on the results of our elections.
