...
* __camera_2018_italy.csv__ that contains the number of votes each party received in each electoral district
* __macro-aree_ that contains information on the macroarea each Italian region belongs to


The first file contains the actual information on the number of votes to each party, while the second file contains additional info that may help us better understand the "geogrpahy" of the votes.
