...
In this post I have given some basics of the _grammar of graphics_. There is a number of packages built on top of it to the extent that a whole website for [ggplot extentions](http://www.ggplot2-exts.org/gallery/) exist! 
